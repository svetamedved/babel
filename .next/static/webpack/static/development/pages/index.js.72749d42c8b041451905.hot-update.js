...
function Airtable() {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_0__["useEffect"])(function () {
    api_base('Products').select().eachPage(function page(records, fetchNextPage) {
      // This function (`page`) will get called for each page of records.
      records.forEach(function (record) {
        fetched_products.push(record);
  ...
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("ul", null, products.map(function (item) {
    return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("li", {
      key: item.get('Name')
    }, react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("h3", null, item.get('Name')), item.get('Briefing'));
  }));
}
...
//# sourceMappingURL=index.js.72749d42c8b041451905.hot-update.js.map